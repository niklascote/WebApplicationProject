...
public class EventView implements Serializable {
    ...
    public void addEvent() {
        if (event.isRecurrent()) {
            ...
            addRecurrentEvent(event.getRecurrentForRange(), event.getRecurrentEveryRange());
        }
    ...
    public Boolean writePremission() {
     ...
     public void addEvent(List<EventParticipant> participants) {
     ...
     */
    public void addRecurrentEvent(int forRange, String everyRange) {
        //Add event to Event-table in DB        
        Event e = new Event(event.getEvent().getTitle(),
                event.getEvent().getCalendar(),
                event.getEvent().getLocation(),
    ...
    public void deleteParticipantEvent() {
    ...
    public void updateEvent(List<EventParticipant> participants) {
